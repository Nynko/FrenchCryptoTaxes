...
impl PortfolioManager {
    ...
    fn _calculate(&self, tx: &Transaction, previous_tx: &Transaction, wallets : &HashMap<String, Wallet>){ // Should need some kind of copy of the wallets for not changing the actual data.
        match tx {
