...
- Knowing the state of a wallet before a specific transactions (for non-taxable transactions fror instance)
- Check the data
*/
fn _calculate_balances(tx: &Transaction, wallets_copy: &mut HashMap<String, Wallet>) {
